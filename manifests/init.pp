...
# @param group_prefix [String] The prefix for the group.
...
# @param use_get_htcondor_metaknob [Boolean] If get_htcondor metaknob should be used.
class htcondor (
  Hash $accounting_groups                  = $htcondor::params::accounting_groups,
  Boolean $cluster_has_multiple_domains    = $htcondor::params::cluster_has_multiple_domains,
  String $collector_name                   = $htcondor::params::collector_name,
  Integer $collector_query_workers         = $htcondor::params::collector_query_workers,
  Optional[Integer] $collector_max_file_descriptors  = $htcondor::params::collector_max_file_descriptors,
  ...
  Integer $claim_worklife                  = $htcondor::params::claim_worklife,
  ...
  Integer $defrag_interval                 = $htcondor::params::defrag_interval,
  Integer $defrag_draining_machines_per_hr = $htcondor::params::defrag_draining_machines_per_hr,
  Integer $defrag_max_concurrent_draining  = $htcondor::params::defrag_max_concurrent_draining,
  Integer $defrag_max_whole_machines       = $htcondor::params::defrag_max_whole_machines,
  String $defrag_schedule                  = $htcondor::params::defrag_schedule,
  String $defrag_rank                      = $htcondor::params::defrag_rank,
  Integer $whole_machine_cpus              = $htcondor::params::whole_machine_cpus,
  ...
  Optional[Hash] $high_priority_groups     = $htcondor::params::high_priority_groups,
  Integer $priority_halflife               = $htcondor::params::priority_halflife,
  ...
  String $group_prefix                     = $htcondor::params::group_prefix,
  ...
  Boolean $include_username_in_accounting  = $htcondor::params::include_username_in_accounting,
  ...
  Integer $number_of_cpus                  = $htcondor::params::number_of_cpus,
  ...
  Optional[String] $queues                 = $htcondor::params::queues,
  Integer $periodic_expr_interval          = $htcondor::params::periodic_expr_interval,
  Integer $max_periodic_expr_interval      = $htcondor::params::max_periodic_expr_interval,
  Integer $remove_held_jobs_after          = $htcondor::params::remove_held_jobs_after,
  ...
  Integer $condor_uid                      = 0,
  Integer $condor_gid                      = 0,
  ...
  String $template_highavailability        = $htcondor::params::template_highavailability,
  Boolean $use_htcondor_account_mapping    = $htcondor::params::use_htcondor_account_mapping,
  ...
  Optional[String] $krb_srv_keytab         = undef,
  Optional[String] $krb_srv_principal      = undef,
  ...
  Integer $dns_cache_refresh               = $htcondor::params::dns_cache_refresh,
  Boolean $use_shared_port                 = $htcondor::params::use_shared_port,
  Integer $shared_port                     = $htcondor::params::shared_port,
  String $shared_port_collector_name       = $htcondor::params::shared_port_collector_name,
  Integer $max_history_log                 = $htcondor::params::max_history_log,
  Integer $max_history_rotations           = $htcondor::params::max_history_rotations,
  ...
  Boolean $use_get_htcondor_metaknob       = $htcondor::params::use_get_htcondor_metaknob,
